...
export const GradientBorderOverlay = styled.div<{ percentage: number }>`
  position: absolute;
  top: 0;
  left: 0;
  bottom: 0;
...
export const GradientTriangleOverlay = styled.div<{ percentage: number }>`
  position: absolute;
  top: 0;
  right: 0;
  width: 0;
...
export const GradientGlowOverlay = styled.div<{ percentage: number }>`
  position: absolute;
  top: 0;
  left: 0;
  right: 0;
...
export const GradientGlowStrongOverlay = styled.div<{ percentage: number }>`
  position: absolute;
  top: 0;
  left: 0;
  right: 0;
...
export const GradientBackgroundOverlay = styled.div<{ percentage: number }>`
  position: absolute;
  top: 0;
  left: 0;
  right: 0;
...
export const RadialProgress = styled.div<{ percentage: number }>`
  width: 100%;
  height: 100%;
  border-radius: 50%;
...
export const TriangleBarsContainer = styled.div`
  position: absolute;
  bottom: 2px;
  left: 50%;
...
export const DiamondBarsContainer = styled.div`
  position: absolute;
  bottom: 2px;
  left: 50%;
  transform: translateX(-50%);
...
export const WingsBarsContainer = styled.div`
  position: absolute;
  bottom: 2px;
  left: 50%;
  transform: translateX(-50%);
...
export const WingsGroup = styled.div`
  display: flex;
  gap: 1px;
  align-items: end;
`;
...
export const DiamondBar = styled.div<{ height: number; show: boolean }>`
  width: 3px;
  height: ${({ height }) => height}px;
...
export const PulseOverlay = styled.div<{ percentage: number }>`
  position: absolute;
  top: 0;
  left: 0;
  right: 0;
...
export const TextureDotsOverlay = styled.div<{ percentage: number }>`
  position: absolute;
  bottom: 0;
  left: 0;
  right: 0;
...
export const TextureDiagonalOverlay = styled.div<{ percentage: number }>`
  position: absolute;
  bottom: 0;
  left: 0;
  right: 0;
...
export const TextureSquaresOverlay = styled.div<{ percentage: number }>`
  position: absolute;
  bottom: 0;
  left: 0;
  right: 0;
...
export const TextureDotsWithUserOverlay = styled.div<{ percentage: number }>`
  position: absolute;
  bottom: 0;
  left: 0;
  right: 0;
...
export const TextureUserDotsOverlay = styled.div<{ percentage: number }>`
  position: absolute;
  bottom: 0;
  left: 0;
  right: 0;
...
export const GrainyHeightOverlay = styled.div<{ percentage: number }>`
  position: absolute;
  bottom: 0;
  left: 0;
  right: 0;
...
export const GrainyHeightIsolate = styled.div`
  isolation: isolate;
  position: absolute;
  bottom: 0;
  left: 0;
...
export const GrainyHeightOverlayBlend = styled.div<{ percentage: number }>`
  position: absolute;
  top: 0;
  width: 100%;
  height: 100%;
...
export const GrainyRadialOverlay = styled.div<{ percentage: number }>`
  position: absolute;
  top: 4px;
  right: 4px;
...
// Grainy Border Fade
export const GrainyBorderOverlay = styled.div<{ percentage: number }>`
  position: absolute;
  top: 0;
  left: 0;
  bottom: 0;
...
export const GrainyBackgroundOverlay = styled.div<{ percentage: number }>`
  position: absolute;
  top: 0;
  left: 0;
  right: 0;
...
export const HolographicContainer = styled.div<{ percentage: number }>`
  position: absolute;
  top: 0;
  left: 0;
  right: 0;
...
export const HolographicNoise = styled.div<{ percentage: number }>`
  width: 100%;
  height: 100%;
  background: linear-gradient(
      24deg,
...
export const HolographicOverlay = styled.div<{ percentage: number }>`
  position: absolute;
  top: 0;
  width: 100%;
  height: 100%;
...
export const GrainyCornerOverlay = styled.div<{ percentage: number }>`
  position: absolute;
  top: 0;
  right: 0;
  width: 0;
...
export const GrainyCornerNoise = styled.div<{ percentage: number }>`
  position: absolute;
  top: 0;
  right: 0;
...
export const GrainyShimmerOverlay = styled.div<{ percentage: number }>`
  position: absolute;
  top: 0;
  left: 0;
  right: 0;
